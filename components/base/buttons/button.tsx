...
export const styles = sortCx({
        common: {
            root: [
                "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-brand transition duration-100 ease-linear before:absolute focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary",
    ...
    sizes: {
        sm: {
            root: [
                "gap-1 rounded-2xl px-3 py-2 text-sm font-semibold before:rounded-[8px] data-icon-only:p-2",
        ...
        md: {
            root: [
                "gap-1 rounded-2xl px-3.5 py-2.5 text-sm font-semibold before:rounded-[8px] data-icon-only:p-2.5",
                "in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3",
            ].join(" "),
            linkRoot: "gap-1",
        },
        lg: {
            root: "gap-1.5 rounded-2xl px-4 py-2.5 text-md font-semibold before:rounded-[8px] data-icon-only:p-3",
            linkRoot: "gap-1.5",
        },
        xl: {
            root: "gap-1.5 rounded-2xl px-4.5 py-3 text-md font-semibold before:rounded-[8px] data-icon-only:p-3.5",
            linkRoot: "gap-1.5",
        },
    },
